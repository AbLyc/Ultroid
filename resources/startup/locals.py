...
#
# This file is a part of < https://github.com/AbLyc/Ultroid/ >
# Please read the GNU Affero General Public License in
# <https://www.github.com/AbLyc/Ultroid/blob/main/LICENSE/>.
...
def start():
    ...
    os.system("git clone https://github.com/AbLyc/Ultroid")
    print("\n\nDone")
    os.chdir("Ultroid")
    clear_screen()
    print(a)
    ...
    if isitdone == "y" or isitdone != "n":
        # https://github.com/AbLyc/Ultroid/blob/31b9eb1f4f8059e0ae66adb74cb6e8174df12eac/resources/startup/locals.py#L35
        f = open(".env", "w")
        f.write(all_done)
    else:
...
def gen_session():
    print("\nProcessing...")
    # https://github.com/AbLyc/Ultroid/main/resources/startup/locals.py#L35
